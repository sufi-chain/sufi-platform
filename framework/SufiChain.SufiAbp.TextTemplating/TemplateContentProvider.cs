...
public class TemplateContentProvider : ITemplateContentProvider, ITransientDependency
{
    ...
    public SufiAbpTextTemplatingOptions Options { get; }
    private readonly ITemplateDefinitionManager _templateDefinitionManager;

    public TemplateContentProvider(
        ITemplateDefinitionManager templateDefinitionManager,
        IServiceScopeFactory serviceScopeFactory,
        IOptions<SufiAbpTextTemplatingOptions> options)
    {
        ...
        bool useCurrentCultureIfCultureNameIsNull = true)
    {
        ...
        if (!Options.ContentContributors.Any())
        {
            throw new AbpException(
                $"No template content contributor was registered. Use {nameof(SufiAbpTextTemplatingOptions)} to register contributors!"
            );
        }
