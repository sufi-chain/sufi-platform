...
public class SufiAbpTemplateRenderer : ITemplateRenderer, ITransientDependency
{
    protected IServiceScopeFactory ServiceScopeFactory { get; }
    protected ITemplateDefinitionManager TemplateDefinitionManager { get; }
    protected SufiAbpTextTemplatingOptions Options { get; }

    public SufiAbpTemplateRenderer(
