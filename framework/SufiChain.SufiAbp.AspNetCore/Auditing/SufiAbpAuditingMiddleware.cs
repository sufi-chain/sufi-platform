...
/// <see cref="SufiAbpAuditingHttpMethodFilterOptions"/> to customize.
/// </summary>
public class SufiAbpAuditingMiddleware : AbpAuditingMiddleware, ITransientDependency
{
    private readonly IAuditingManager _auditingManager;
    private readonly SufiAbpAuditingHttpMethodFilterOptions _methodFilterOptions;

    public SufiAbpAuditingMiddleware(
        ...
        IOptions<SufiAbpAuditingHttpMethodFilterOptions> methodFilterOptions,
