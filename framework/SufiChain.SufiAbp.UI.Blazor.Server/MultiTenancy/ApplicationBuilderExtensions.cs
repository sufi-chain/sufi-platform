...
public static class ApplicationBuilderExtensions
{
    ...
    /// If the host already has an MVC controller handling this route (e.g. <c>SufiAbpAccountController</c>),
    ...
    private static async Task HandleTenantSwitchAsync(HttpContext context)
    {
        var logger = context.RequestServices.GetRequiredService<ILoggerFactory>()
            .CreateLogger("SufiChain.SufiAbp.UI.TenantSwitch");
    ...
    /// <summary>
    /// Resolves a tenant name to a GUID string via the SufiAbp tenant lookup service.
