...
public abstract class CrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
    : CrudAppService<TEntity, TEntityDto, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput>,
      ISufiCrudAppService<TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
    where TEntity : class, IEntity<TKey>
{
    protected CrudAppService(IRepository<TEntity, TKey> repository)
        : base(repository)
...
/// <summary>
/// Sufi-branded CRUD application service base class.
/// </summary>
public abstract class SufiCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput>
    : SufiCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput, TCreateInput>
    where TEntity : class, IEntity<TKey>
{
    protected SufiCrudAppService(IRepository<TEntity, TKey> repository)
        : base(repository)
    {
    }
}
...
/// <summary>
/// Sufi-branded CRUD application service with full customization.
/// </summary>
public abstract class SufiCrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput>
