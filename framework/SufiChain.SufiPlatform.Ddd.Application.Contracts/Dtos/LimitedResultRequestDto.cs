...
public class LimitedResultRequestDto : ILimitedResultRequest, IValidatableObject
{
    ...
    public virtual IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        {
            var localizer = validationContext.GetRequiredService<IStringLocalizer<SufiDddApplicationContractsResource>>();
...
/// </summary>
[Serializable]
public class SufiExtensibleLimitedResultRequestDto : ExtensibleObject, ILimitedResultRequest, IValidatableObject
{
    /// <summary>
    /// Default value: 10.
    /// </summary>
        ...
        if (MaxResultCount > MaxMaxResultCount)
        {
            ...
            yield return new ValidationResult(
                localizer[
                    ...
                    nameof(MaxResultCount),
                    MaxMaxResultCount,
                    typeof(SufiExtensibleLimitedResultRequestDto).FullName!,
                    nameof(MaxMaxResultCount)
                ],
                new[] { nameof(MaxResultCount) });
        }
