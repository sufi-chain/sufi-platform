...
namespace SufiChain.SufiAbp.UI.Blazor.Security;
...
/// </summary>
public class SufiAbpComponentsClaimsCache : IDisposable
{
    ...
    public SufiAbpComponentsClaimsCache(AuthenticationStateProvider? authenticationStateProvider = null)
    {
