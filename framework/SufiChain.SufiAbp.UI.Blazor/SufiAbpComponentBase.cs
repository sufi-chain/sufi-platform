...
/// </summary>
public abstract class SufiAbpComponentBase : OwningComponentBase
{
    ...
    /// Defaults to SufiAbpFrameworkResource if no LocalizationResource is set.
    /// </summary>
        ...
        get
        {
            if (_localizer == null)
            {
                _localizer = LocalizationResource != null
                    ...
                    : StringLocalizerFactory.Create(typeof(SufiAbpFrameworkResource));
            }
            return _localizer;
        }
    }
