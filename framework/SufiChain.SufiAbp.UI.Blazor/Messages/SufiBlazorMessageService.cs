...
namespace SufiChain.SufiAbp.UI.Blazor.Messages;
...
public class SufiBlazorMessageService : IUiMessageService
{
    ...
    /// <summary>
    /// Registers the confirm dialog handler (called by SufiAbpOverlayHost).
    /// </summary>
    ...
    /// <summary>
    /// Registers the message dialog handler (called by SufiAbpOverlayHost).
    /// </summary>
    ...
    /// <summary>
    /// Unregisters handlers for a circuit (called when SufiAbpOverlayHost is disposed).
    /// </summary>
