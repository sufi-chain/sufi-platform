...
using SufiChain.SufiAbp.UI.Extensibility.EntityActions;
using SufiChain.SufiAbp.UI.Extensibility.TableColumns;
...
public abstract class SufiAbpCrudPageBase<TEntityDto, TKey> 
    : SufiAbpCrudPageBase<TEntityDto, TKey, TEntityDto, TEntityDto>
...
public abstract class SufiAbpCrudPageBase<TEntityDto, TKey, TCreateInput, TUpdateInput>
    : SufiAbpCrudPageBase<TEntityDto, TEntityDto, TKey, TCreateInput, TUpdateInput>
    where TEntityDto : class, new()
...
/// <typeparam name="TCreateInput">The type for create operations.</typeparam>
/// <typeparam name="TUpdateInput">The type for update operations.</typeparam>
public abstract class SufiAbpCrudPageBase<TGetOutputDto, TGetListOutputDto, TKey, TCreateInput, TUpdateInput>
