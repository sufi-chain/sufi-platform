...
/// Stable public contract; a provider module (e.g. AIManagement) replaces the Null
/// default. Provider SDK types are never exposed here.
/// </summary>
public interface ISufiAbpAIAudioService
{
    /// <summary>
    ...
    /// </summary>
    Task<SufiAbpAITranscriptionResponse> TranscribeAsync(
