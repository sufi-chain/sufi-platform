...
/// </summary>
public interface ISufiAbpAccessTokenProvider
{
    /// <summary>
    ...
    ValueTask<SufiAbpAccessTokenResult> RequestAccessTokenAsync();
    ...
    /// <returns>The access token result containing the token if successful.</returns>
    ValueTask<SufiAbpAccessTokenResult> RequestAccessTokenAsync(SufiAbpAccessTokenRequestOptions options);
}

/// <summary>
/// Options for requesting an access token.
/// </summary>
public class SufiAbpAccessTokenRequestOptions
{
    /// <summary>
...
/// </summary>
public class SufiAbpAccessTokenResult
{
    /// <summary>
    /// Creates a successful result.
    /// </summary>
    public static SufiAbpAccessTokenResult Success(SufiAbpAccessToken token) => new()
    {
        Status = SufiAbpAccessTokenResultStatus.Success,
        Token = token
    };
    ...
    /// </summary>
    public static SufiAbpAccessTokenResult RequiresRedirect(string redirectUrl) => new()
    {
        Status = SufiAbpAccessTokenResultStatus.RequiresRedirect,
    ...
    /// </summary>
    public SufiAbpAccessTokenResultStatus Status { get; set; }

    /// <summary>
    /// The access token if the request was successful.
    /// </summary>
    public SufiAbpAccessToken? Token { get; set; }
    ...
    /// </summary>
    public bool TryGetToken(out SufiAbpAccessToken? token)
    {
        token = Token;
        return Status == SufiAbpAccessTokenResultStatus.Success && token != null;
    }
}
...
/// </summary>
public enum SufiAbpAccessTokenResultStatus
{
    /// <summary>
...
/// </summary>
public class SufiAbpAccessToken
{
    /// <summary>
