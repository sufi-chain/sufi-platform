...
namespace SufiChain.SufiAbp.CLI.ProjectBuilding;
...
public class ProjectBuildContext
{
    ...
    public void InitializeReplacements()
    {
        ...
        // ============================================================
        // LEGACY: Also include SufiPlatform.DemoApp replacements
        // in case loading from hosts directly (development mode)
        // ============================================================
        Replacements["SufiPlatform.DemoApp"] = Args.SolutionName;
        Replacements["SufiPlatform"] = Args.CompanyName;
        ...
        Replacements["SufiPlatformDemoApp"] = Args.CompanyName + Args.ProjectName;
