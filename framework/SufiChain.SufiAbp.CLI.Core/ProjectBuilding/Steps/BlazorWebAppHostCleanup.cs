...
internal static class BlazorWebAppHostCleanup
{
    ...
    private static void CleanupWebAppProject(ProjectBuildContext context, bool removeLocalAuthServer)
    {
        ...
        foreach (var file in webAppCsprojFiles)
        {
            ...
            content = RemoveReferenceLines(content, "SufiAbp.Swashbuckle");
    ...
    private static void RemoveLocalApplicationAndDatabaseHosting(ProjectBuildContext context)
    {
        ...
        foreach (var file in webAppCsprojFiles)
        {
            ...
            content = RemovePackageReferenceLines(content, "MenuManagement.Application");
            ...
            content = RemovePackageReferenceLines(content, "FeatureManagement.Application");
            content = RemovePackageReferenceLines(content, "SettingManagement.Application");
            content = RemovePackageReferenceLines(content, "Account.Application");
            content = RemovePackageReferenceLines(content, "PermissionManagement.Application");
            content = RemovePackageReferenceLines(content, "LocalizationManagement.Application");
