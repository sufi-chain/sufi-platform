...
namespace SufiChain.SufiPlatform.UI.Blazor.Notifications;
...
public class SufiBlazorNotificationService : IUiNotificationService
{
    ...
    /// <summary>
    /// Registers handlers for a specific circuit. Only that circuit's SufiOverlayHost will receive notifications.
    /// Call from SufiOverlayHost.OnInitialized when circuit ID is available.
    /// </summary>
    ...
    /// <summary>
    /// Unregisters the handler for a circuit. Call from SufiOverlayHost.Dispose.
    /// </summary>
