...
namespace SufiChain.SufiPlatform.UI.Blazor.Http;
...
/// </summary>
public class SufiBlazorClientHttpMessageHandler : DelegatingHandler
{
    private const string AntiForgeryCookieName = "XSRF-TOKEN";
    private const string AntiForgeryHeaderName = "RequestVerificationToken";
    private const string SelectedLanguageKey = "Sufi.SelectedLanguage";

    private readonly IJSRuntime _jsRuntime;
    private readonly ICookieService _cookieService;
    private readonly NavigationManager _navigationManager;

    public SufiBlazorClientHttpMessageHandler(
