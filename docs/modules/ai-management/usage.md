...
Operator workflows for the AI Management admin UI. Routes live under `/admin/ai-management/`.
...
**Path:** `/admin/ai-management/workspaces`
...
**Path:** `/admin/ai-management/model-configurations`
...
**Path:** `/admin/ai-management/test-chat`  
**Permission:** `AIManagement.TestChat.Default`
...
**Path:** `/admin/ai-management/multimodal-test`  
**Permission:** Testing menu requires `AIManagement.TestChat.Default`; each capability tab requires its own permission (`AIManagement.AI.Chat`, `.Audio`, `.Vision`, `.Embeddings`).
...
**Path:** `/admin/ai-management/usage-analytics`  
**Permission:** `AIManagement.AI.ViewUsage`
...
**Path:** `/admin/ai-management/rag`  
**Permission:** `AIManagement.RAG.Default`
...
**Path:** `/admin/ai-management/indexing-status`  
**Permission:** `AIManagement.RAG.Default` (start indexing may require `AIManagement.RAG.Index` when enforced on the action)
...
**Path:** `/admin/ai-management/mcp-servers`  
**Permissions:** view `AIManagement.MCPServers.Default`; create/edit/delete as named
...
**Path:** `/admin/ai-management/mcp-tools`
