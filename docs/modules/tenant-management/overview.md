...
- `SufiChain.SufiPlatform.Tenants.Blazor` for the main management UI
- `SufiChain.SufiPlatform.Tenants.Application` and `.Application.Contracts` for tenant workflows and contracts
- `SufiChain.SufiPlatform.Tenants.Domain` for tenant-specific domain behavior
- `SufiChain.SufiPlatform.Tenants.HttpApi` for the remote management surface
