# Dynamic Settings Configuration for Messaging Providers
...
When you install a messaging provider (e.g., Twilio, SendGrid), its settings should automatically become available in:
...
@code {
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        foreach (var definition in definitions.Where(d => d.Name.StartsWith("SufiAbp.Messaging")))
        {
    ...
    private Dictionary<string, List<SettingDefinition>> GetSettingGroups()
    {
        var definitions = SettingDefinitionManager.GetAll()
            .Where(d => d.Name.StartsWith("SufiAbp.Messaging"));
...
{
  "Settings": {
    "SufiAbp.Messaging.Twilio.AccountSid": "ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    "SufiAbp.Messaging.Twilio.AuthToken": "your-auth-token-here",
    "SufiAbp.Messaging.Twilio.DefaultFromNumber": "+1234567890",
    "SufiAbp.Messaging.Twilio.Sms.StatusCallbackUrl": "https://myapp.com/api/twilio/sms-status",
    "SufiAbp.Messaging.Twilio.Voice.Url": "https://myapp.com/api/twilio/voice",
    "SufiAbp.Messaging.Twilio.Voice.StatusCallbackUrl": "https://myapp.com/api/twilio/voice-status",
    "SufiAbp.Messaging.Twilio.Voice.Method": "POST"
  }
}
```
