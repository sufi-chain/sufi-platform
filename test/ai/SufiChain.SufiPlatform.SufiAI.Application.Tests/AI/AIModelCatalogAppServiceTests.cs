...
public class AIModelCatalogAppServiceTests : SufiAITestBase<SufiAIApplicationTestModule>
{
    ...
    [Fact]
    public async Task Should_Intersect_Copilot_Allowlist()
    {
        ...
        TestCopilotPolicy.Current.Value = new AICopilotModelSelectionPolicy
        {
            CopilotId = copilotId,
            WorkspaceId = workspace.Id,
        ...
        {
            TestCopilotPolicy.Current.Value = null;
        }
    }
