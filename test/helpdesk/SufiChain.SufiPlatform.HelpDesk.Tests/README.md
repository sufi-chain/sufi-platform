...
area: pro-module
status: active
source_path: "sufi-platform/test/helpdesk/SufiChain.SufiPlatform.HelpDesk.Tests/SufiChain.SufiPlatform.HelpDesk.Tests.csproj"
tags:
  - project
  - ai-kb
  - kb/area/pro-module
...
The project source is `sufi-platform/test/helpdesk/SufiChain.SufiPlatform.HelpDesk.Tests/SufiChain.SufiPlatform.HelpDesk.Tests.csproj`.
