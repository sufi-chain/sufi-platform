...
public class CopilotRuntimeCitationMappingTests
{
    [Fact]
    public void MapCitations_Should_Cap_At_RagTopK()
    {
        ...
        var citations = CopilotRuntimeOrchestrator.MapCitations(chunks, ragTopK: 3);
    ...
    public void MapCitations_Should_Truncate_Snippet()
    {
        ...
        var citations = CopilotRuntimeOrchestrator.MapCitations(chunks, ragTopK: 5, snippetLength: 400);
