...
public class CopilotImprovementProposalTests
{
    [Fact]
    ...
    public void Should_Record_Review_And_Apply_Audit_Data()
    {
        ...
        proposal.Status.ShouldBe(CopilotImprovementProposalStatus.Applied);
    ...
    public void Should_Reject_Pending_Proposal()
    {
        ...
        proposal.Status.ShouldBe(CopilotImprovementProposalStatus.Rejected);
        proposal.ReviewedBy.ShouldBe(reviewerId);
        proposal.ReviewedTime.ShouldBe(reviewedTime);
    }

    private static CopilotImprovementProposal CreateProposal()
    {
        return new CopilotImprovementProposal(
            Guid.NewGuid(),
            null,
            Guid.NewGuid(),
            Guid.NewGuid(),
