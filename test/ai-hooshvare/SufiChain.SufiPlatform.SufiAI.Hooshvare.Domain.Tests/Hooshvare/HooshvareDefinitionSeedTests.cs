...
public class HooshvareDefinitionSeedTests

{
...

    {
        ...
        definition.Key!.Length.ShouldBeLessThanOrEqualTo(HooshvareConsts.MaxKeyLength);
    ...
    [InlineData("other.key", "SufiAI.Hooshvare", "Assistant", HooshvareKind.Assistant)]

    [InlineData("test.assistant", "OtherModule", "Assistant", HooshvareKind.Assistant)]
    ...
    private static PlatformHooshvareSeedDefinition CreateSeed(
...

    {
        ...
        return new PlatformHooshvareSeedDefinition
