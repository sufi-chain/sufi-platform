...
public static class SufiAbpBackgroundJobsDbContextModelCreatingExtensions
{
    public static void ConfigureSufiAbpBackgroundJobs(
        this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SufiAbpBackgroundJobsDbProperties.DbTablePrefix + "BackgroundJobs", SufiAbpBackgroundJobsDbProperties.DbSchema);
