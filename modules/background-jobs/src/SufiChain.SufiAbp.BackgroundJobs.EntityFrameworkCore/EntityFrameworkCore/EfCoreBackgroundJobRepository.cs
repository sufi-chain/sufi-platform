...
public class EfCoreBackgroundJobRepository : EfCoreRepository<ISufiAbpBackgroundJobsDbContext, BackgroundJobRecord, Guid>, IBackgroundJobRepository
{
    protected IClock Clock { get; }

    public EfCoreBackgroundJobRepository(
        IDbContextProvider<ISufiAbpBackgroundJobsDbContext> dbContextProvider,
        IClock clock)
