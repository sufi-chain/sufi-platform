...
namespace SufiChain.SufiPlatform.FileManager.Application.Tests.Processing;

public class ImageProcessorTests : FileManagerApplicationTestBase<SufiFileManagerApplicationTestModule>
{
