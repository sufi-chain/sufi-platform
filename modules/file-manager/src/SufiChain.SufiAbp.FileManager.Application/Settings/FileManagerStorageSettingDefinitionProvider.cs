...
public class FileManagerStorageSettingDefinitionProvider : SettingDefinitionProvider
{
    public override void Define(ISettingDefinitionContext context)
    {
        context.Add(
            ...
            new SettingDefinition(FileManagerStorageSettingNames.Database.ConnectionString, null, isVisibleToClients: false, isEncrypted: true),
            ...
            new SettingDefinition(FileManagerStorageSettingNames.MinIO.AccessKey, null, isVisibleToClients: false, isEncrypted: true),
            new SettingDefinition(FileManagerStorageSettingNames.MinIO.SecretKey, null, isVisibleToClients: false, isEncrypted: true),
            ...
            new SettingDefinition(FileManagerStorageSettingNames.S3.AccessKeyId, null, isVisibleToClients: false, isEncrypted: true),
            new SettingDefinition(FileManagerStorageSettingNames.S3.SecretAccessKey, null, isVisibleToClients: false, isEncrypted: true),
