...
public class EfCoreFileItemRepository :
    EfCoreRepository<ISufiAbpFileManagerDbContext, FileItem, Guid>,
    IFileItemRepository
{
    public EfCoreFileItemRepository(IDbContextProvider<ISufiAbpFileManagerDbContext> dbContextProvider)
    ...
    private IQueryable<FileItem> ApplySearchFilters(
        ISufiAbpFileManagerDbContext dbContext,
