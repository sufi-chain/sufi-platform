...
public class EfCoreFileFolderRepository :
    EfCoreRepository<ISufiAbpFileManagerDbContext, FileFolder, Guid>,
    IFileFolderRepository
{
    public EfCoreFileFolderRepository(IDbContextProvider<ISufiAbpFileManagerDbContext> dbContextProvider)
