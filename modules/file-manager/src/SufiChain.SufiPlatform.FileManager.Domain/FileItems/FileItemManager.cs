...
public class FileItemManager : DomainService
{
    ...
    private async Task CheckEnableFeatureAsync()
    {
        ...
        {
            throw new BusinessException($"Feature is disabled: {SufiFileManagerFeatures.Enable}");
        }
    }
    ...
    private async Task CheckFileItemsFeatureAsync()
    {
        ...
        if (!await _featureChecker.IsEnabledAsync(SufiFileManagerFeatures.FileItems))
        {
            throw new BusinessException($"Feature is disabled: {SufiFileManagerFeatures.FileItems}");
        }
    }
    ...
    private async Task CheckArchivingFeatureAsync()
    {
        ...
        if (!await _featureChecker.IsEnabledAsync(SufiFileManagerFeatures.Archiving))
        {
            throw new BusinessException($"Feature is disabled: {SufiFileManagerFeatures.Archiving}");
        }
    }
