...
```razor
<FileBrowser StructureKey="@SufiChain.SufiAbp.FileManager.Configuration.FileStructureKeys.General" />
```

Or with a using: `@using SufiChain.SufiAbp.FileManager.Configuration`:
```razor
