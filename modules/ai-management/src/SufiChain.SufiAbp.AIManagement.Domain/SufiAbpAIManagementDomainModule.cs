...
using SufiChain.SufiAbp.AIManagement.MCP.Execution;
using SufiChain.SufiAbp.AIManagement.MCP.Internal;
using SufiChain.SufiAbp.AIManagement.MCP.Registry;
using SufiChain.SufiAbp.AIManagement.RAG;
using SufiChain.SufiAbp.AIManagement.RAG.Services;
...
[DependsOn(
    ...
    typeof(SufiAbpAIModule)
)]
public class SufiAbpAIManagementDomainModule : AbpModule
{
