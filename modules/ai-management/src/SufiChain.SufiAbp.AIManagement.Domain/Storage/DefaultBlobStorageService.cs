...
public class DefaultBlobStorageService : IAIFileStorageService, ITransientDependency
{
        ...
        object? metadata = null)
    {
        ...
        // Generate blob path: ai-management/{workspace}/{capability}/{yyyy-MM}/{guid}.ext
        ...
        var fileUrl = $"/api/ai-management/files/{fileId}";
    ...
    public async Task<string> GetFileUrlAsync(Guid fileId)
    {
        ...
        return $"/api/ai-management/files/{fileId}";
    }
    ...
    private string GenerateBlobPath(string workspaceName, string capability, string fileName, Guid fileId)
    {
        ...
        return $"ai-management/{sanitizedWorkspace}/{sanitizedCapability}/{now:yyyy-MM}/{fileId}{extension}";
    }
