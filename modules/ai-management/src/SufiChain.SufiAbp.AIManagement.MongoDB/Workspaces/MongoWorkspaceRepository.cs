...
public class MongoWorkspaceRepository : MongoDbRepository<AIManagementMongoDbContext, Workspace, Guid>, IWorkspaceRepository
{
    public MongoWorkspaceRepository(IMongoDbContextProvider<AIManagementMongoDbContext> dbContextProvider)
