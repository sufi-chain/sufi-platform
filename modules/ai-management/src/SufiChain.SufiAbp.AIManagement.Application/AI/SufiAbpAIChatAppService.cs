...
public class SufiAbpAIChatAppService : SufiAbpApplicationService, ISufiAbpAIChatAppService
{
    ...
    public SufiAbpAIChatAppService(
        ISufiAbpAIChatService chatService,
    ...
    [RequiresFeature(SufiAbpAIFeatures.Chat, SufiAbpAIFeatures.MCP)]
    [Authorize(AIManagementPermissions.MCPTools.Execute)]
    public virtual async Task<SufiAbpAIChatResponseDto> SendMessageWithToolsAsync(SufiAbpAISendChatMessageInput input)
    {
