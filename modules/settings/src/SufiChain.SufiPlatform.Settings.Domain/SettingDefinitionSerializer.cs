...
public class SettingDefinitionSerializer : ISettingDefinitionSerializer, ITransientDependency
{
    ...
    public virtual Task<SettingDefinitionRecord> SerializeAsync(AbpSettingDefinition setting)
    {
    ...
    public virtual async Task<List<SettingDefinitionRecord>> SerializeAsync(
        IEnumerable<AbpSettingDefinition> settings)
    {
