...
public class EfCoreSettingRepository : EfCoreRepository<ISettingsDbContext, Setting, Guid>,
    ISettingRepository
{
    public EfCoreSettingRepository(IDbContextProvider<ISettingsDbContext> dbContextProvider)
