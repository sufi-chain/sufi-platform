...
public class MongoSettingRepository : MongoDbRepository<ISettingsMongoDbContext, Setting, Guid>,
    ISettingRepository
{
    public MongoSettingRepository(IMongoDbContextProvider<ISettingsMongoDbContext> dbContextProvider)
