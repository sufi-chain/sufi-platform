...
namespace SufiChain.SufiPlatform.Permissions.Controllers;


[Area(PermissionsRemoteServiceConsts.ModuleName)]
[RemoteService(Name = PermissionsRemoteServiceConsts.RemoteServiceName)]
[Route("api/permissions/permissions")]
public class PermissionsController : SufiControllerBase, IPermissionAppService
{
