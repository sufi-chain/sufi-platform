...
public class EfCorePermissionGrantRepository :
    EfCoreRepository<ISufiPermissionsDbContext, PermissionGrant, Guid>,
    IPermissionGrantRepository
{
    public EfCorePermissionGrantRepository(IDbContextProvider<ISufiPermissionsDbContext> dbContextProvider)
