...
public class PermissionAppService : SufiApplicationService, IPermissionAppService
{
    ...
    {
        LocalizationResource = typeof(SufiPermissionsResource);
        ObjectMapperContext = typeof(SufiPermissionsApplicationModule);
