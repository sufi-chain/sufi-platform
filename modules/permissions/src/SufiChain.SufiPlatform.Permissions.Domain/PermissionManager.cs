...
public class PermissionManager : IPermissionManager, ISingletonDependency
{
    ...
    protected IReadOnlyList<IPermissionsProvider> ManagementProviders => _lazyProviders.Value;

    protected PermissionsOptions Options { get; }

    protected IDistributedCache<PermissionGrantCacheItem> Cache { get; }

    private readonly Lazy<List<IPermissionsProvider>> _lazyProviders;
        ...
        IDistributedCache<PermissionGrantCacheItem> cache)
    {
        ...
        _lazyProviders = new Lazy<List<IPermissionsProvider>>(
            () => Options
                .ManagementProviders
                .Select(c => serviceProvider.GetRequiredService(c) as IPermissionsProvider)
                .ToList(),
            true
        );
    }
