...
public class DynamicPermissionDefinitionStore : IDynamicPermissionDefinitionStore, ITransientDependency
{
    ...
    public PermissionsOptions PermissionsOptions { get; }
    ...
    public DynamicPermissionDefinitionStore(
        ...
        IOptions<PermissionsOptions> permissionManagementOptions,
        IAbpDistributedLock distributedLock)
    {
        ...
        PermissionsOptions = permissionManagementOptions.Value;
        CacheOptions = cacheOptions.Value;
    }

    public virtual async Task<PermissionDefinition> GetOrNullAsync(string name)
    {
        if (!PermissionsOptions.IsDynamicPermissionStoreEnabled)
        {
            return null;
        }
