...
public class MongoResourcePermissionGrantRepository : MongoDbRepository<IPermissionsMongoDbContext, ResourcePermissionGrant, Guid>, IResourcePermissionGrantRepository
{
    public MongoResourcePermissionGrantRepository(IMongoDbContextProvider<IPermissionsMongoDbContext> dbContextProvider)
