...
public static class SufiAuditLoggingDbContextModelCreatingExtensions
{
    public static void ConfigureSufiAuditLogging(
        [NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SufiAuditLoggingDbProperties.DbTablePrefix + "AuditLogs", SufiAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAuditLoggingDbProperties.DbTablePrefix + "AuditLogActions", SufiAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAuditLoggingDbProperties.DbTablePrefix + "EntityChanges", SufiAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAuditLoggingDbProperties.DbTablePrefix + "EntityPropertyChanges", SufiAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAuditLoggingDbProperties.DbTablePrefix + "AuditLogExcelFiles", SufiAuditLoggingDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.TryConfigureObjectExtensions<SufiAuditLoggingDbContext>();
    }
}
