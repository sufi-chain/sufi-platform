...
public static class SufiAbpAuditLoggingDbContextModelCreatingExtensions
{
    public static void ConfigureSufiAbpAuditLogging(
        [NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SufiAbpAuditLoggingDbProperties.DbTablePrefix + "AuditLogs", SufiAbpAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpAuditLoggingDbProperties.DbTablePrefix + "AuditLogActions", SufiAbpAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpAuditLoggingDbProperties.DbTablePrefix + "EntityChanges", SufiAbpAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpAuditLoggingDbProperties.DbTablePrefix + "EntityPropertyChanges", SufiAbpAuditLoggingDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpAuditLoggingDbProperties.DbTablePrefix + "AuditLogExcelFiles", SufiAbpAuditLoggingDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.TryConfigureObjectExtensions<SufiAbpAuditLoggingDbContext>();
    }
}
