...
namespace SufiChain.SufiAbp.Account.Blazor.Components;

public partial class SufiAbpCaptcha : ComponentBase, IAsyncDisposable
{
    ...
    private DotNetObjectReference<SufiAbpCaptcha>? _dotNetRef;
