...
public static class AIDbContextModelCreatingExtensions
{
    public static void ConfigureSufiAI(this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AIDbProperties.DbTablePrefix + "Workspaces", AIDbProperties.DbSchema);
        ...
        {
            b.ToTable(AIDbProperties.DbTablePrefix + "ModelConfigurations", AIDbProperties.DbSchema);
        ...
        {
            b.ToTable(AIDbProperties.DbTablePrefix + "UsageLogs", AIDbProperties.DbSchema);
        ...
        {
            b.ToTable(AIDbProperties.DbTablePrefix + "MCPServers", AIDbProperties.DbSchema);
