...
public class EfCoreLocalizationResourceRepository
    : EfCoreRepository<ISufiAbpLocalizationManagementDbContext, LocalizationResource, Guid>,
      ILocalizationResourceRepository
{
    public EfCoreLocalizationResourceRepository(IDbContextProvider<ISufiAbpLocalizationManagementDbContext> dbContextProvider)
