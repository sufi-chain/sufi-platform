...
public class MongoLocalizationResourceRepository
    : MongoDbRepository<LocalizationManagementMongoDbContext, LocalizationResource, Guid>,
      ILocalizationResourceRepository
{
    public MongoLocalizationResourceRepository(IMongoDbContextProvider<LocalizationManagementMongoDbContext> dbContextProvider)
