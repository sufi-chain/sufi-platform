...
public class MongoLocalizationTextRepository
    : MongoDbRepository<LocalizationManagementMongoDbContext, LocalizationText, Guid>,
      ILocalizationTextRepository
{
    public MongoLocalizationTextRepository(IMongoDbContextProvider<LocalizationManagementMongoDbContext> dbContextProvider)
