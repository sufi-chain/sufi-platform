...
public class EfCoreDatabaseBlobRepository : EfCoreRepository<ISufiAbpBlobStoringDbContext, DatabaseBlob, Guid>, IDatabaseBlobRepository
{
    public EfCoreDatabaseBlobRepository(IDbContextProvider<ISufiAbpBlobStoringDbContext> dbContextProvider)
