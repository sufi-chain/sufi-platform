...
public class DatabaseBlobProvider : BlobProviderBase, ITransientDependency
{
    ...
    public override async Task SaveAsync(BlobProviderSaveArgs args)
    {
        ...
        if (blob != null)
        {
            ...
            await DatabaseBlobRepository.UpdateAsync(blob, autoSave: true, cancellationToken: args.CancellationToken);
            return;
        }

        blob = new DatabaseBlob(GuidGenerator.Create(), container.Id, args.BlobName, content, CurrentTenant.Id);
        await DatabaseBlobRepository.InsertAsync(blob, autoSave: true, cancellationToken: args.CancellationToken);
    }
    ...
    public override async Task<bool> DeleteAsync(BlobProviderDeleteArgs args)
    {
        ...
        return await DatabaseBlobRepository.DeleteAsync(container.Id, args.BlobName, autoSave: true, cancellationToken: args.CancellationToken);
    }
    ...
    protected virtual async Task<DatabaseBlobContainer> GetOrCreateContainerAsync(string name, CancellationToken cancellationToken = default)
    {
