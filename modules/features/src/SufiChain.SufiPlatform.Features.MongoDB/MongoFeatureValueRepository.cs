...
public class MongoFeatureValueRepository :
    MongoDbRepository<IFeaturesMongoDbContext, FeatureValue, Guid>,
    IFeatureValueRepository
{
    public MongoFeatureValueRepository(IMongoDbContextProvider<IFeaturesMongoDbContext> dbContextProvider)
