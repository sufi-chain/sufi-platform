...
public class FeatureManager : IFeatureManager, ISingletonDependency
{
    ...
    protected List<IFeaturesProvider> Providers => _lazyProviders.Value;
    protected FeaturesOptions Options { get; }
    protected IStringLocalizerFactory StringLocalizerFactory { get; }

    private readonly Lazy<List<IFeaturesProvider>> _lazyProviders;
        ...
        IStringLocalizerFactory stringLocalizerFactory)
    {
        ...
        _lazyProviders = new Lazy<List<IFeaturesProvider>>(
            () => Options
                .Providers
                .Select(c => serviceProvider.GetRequiredService(c) as IFeaturesProvider)
                .ToList(),
            true
        );
    }
