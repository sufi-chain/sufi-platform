...
public class EfCoreDatabaseBlobContainerRepository : EfCoreRepository<ISufiBlobDatabaseDbContext, DatabaseBlobContainer, Guid>, IDatabaseBlobContainerRepository
{
    public EfCoreDatabaseBlobContainerRepository(IDbContextProvider<ISufiBlobDatabaseDbContext> dbContextProvider)
