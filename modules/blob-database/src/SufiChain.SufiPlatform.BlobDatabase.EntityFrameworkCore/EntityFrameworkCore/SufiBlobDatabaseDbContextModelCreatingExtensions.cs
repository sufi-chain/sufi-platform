...
public static class SufiBlobDatabaseDbContextModelCreatingExtensions
{
    public static void ConfigureSufiBlobDatabase(this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(
                SufiBlobDatabaseDbProperties.DbTablePrefix + "BlobContainers",
                SufiBlobDatabaseDbProperties.DbSchema);
        ...
        {
            b.ToTable(
                SufiBlobDatabaseDbProperties.DbTablePrefix + "Blobs",
                SufiBlobDatabaseDbProperties.DbSchema);
        ...
        builder.TryConfigureObjectExtensions<SufiBlobDatabaseDbContext>();
    }
}
