...
public class BusinessLocalizationEditorAppService : SufiApplicationService, IBusinessLocalizationEditorAppService
{
    ...
    private readonly SufiDataSeedOptions _dataSeedOptions;
