...
[Authorize(LocalizationPermissions.Resources.Default)]
public class LocalizationResourceAppService : SufiApplicationService, ILocalizationResourceAppService
{
    ...
    public async Task<PagedResultDto<LocalizationResourceDto>> GetListAsync(GetLocalizationResourcesInput input)
    {
        ...
        resources = resources
            .Where(r => !SufiLocalizationResourceNameMap.IsReplacedAbpResource(r.ResourceName))
            .ToList();
    ...
    public async Task<List<LocalizationResourceSummaryDto>> GetSummaryListAsync()
    {
        ...
        foreach (var dbResource in dbResources.Where(r =>
                     ...
                     !SufiLocalizationResourceNameMap.IsReplacedAbpResource(r.ResourceName)))
        {
    ...
    [Authorize(LocalizationPermissions.Resources.Create)]
    public async Task<LocalizationResourceDto> CreateAsync(CreateUpdateLocalizationResourceDto input)
    {
        ...
        {
            throw new BusinessException("SufiChain.SufiPlatform.Localization:010001")
    ...
    [Authorize(LocalizationPermissions.Resources.Update)]
    ...
    [Authorize(LocalizationPermissions.Resources.Delete)]
