...
/// <see cref="MaxValueLength"/> matches hooshvare system-prompt capacity because
/// seeded hooshvares store prompts as business localization values.
/// </summary>
public static class LocalizationTextConsts
{
    ...
    /// <summary>
    /// Must stay at least <c>HooshvareConsts.MaxSystemPromptLength</c> (16000).
