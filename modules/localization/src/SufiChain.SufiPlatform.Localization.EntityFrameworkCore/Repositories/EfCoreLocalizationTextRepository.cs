...
public class EfCoreLocalizationTextRepository
    : EfCoreRepository<ISufiLocalizationDbContext, LocalizationText, Guid>,
      ILocalizationTextRepository
{
    public EfCoreLocalizationTextRepository(IDbContextProvider<ISufiLocalizationDbContext> dbContextProvider)
