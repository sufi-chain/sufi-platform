...
public class EfCoreBackgroundJobRepository : EfCoreRepository<ISufiBackgroundJobsDbContext, BackgroundJobRecord, Guid>, IBackgroundJobRepository
{
    protected IClock Clock { get; }

    public EfCoreBackgroundJobRepository(
        IDbContextProvider<ISufiBackgroundJobsDbContext> dbContextProvider,
        IClock clock)
