...
public class EfCoreIdentityLinkUserRepository : EfCoreRepository<ISufiIdentityDbContext, IdentityLinkUser, Guid>, IIdentityLinkUserRepository
{
    public EfCoreIdentityLinkUserRepository(IDbContextProvider<ISufiIdentityDbContext> dbContextProvider)
