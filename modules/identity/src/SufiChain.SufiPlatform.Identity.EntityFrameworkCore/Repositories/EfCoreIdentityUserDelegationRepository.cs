...
public class EfCoreIdentityUserDelegationRepository : EfCoreRepository<ISufiIdentityDbContext, IdentityUserDelegation, Guid>, IIdentityUserDelegationRepository
{
    public EfCoreIdentityUserDelegationRepository(IDbContextProvider<ISufiIdentityDbContext> dbContextProvider)
