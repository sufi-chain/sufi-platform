...
public class EfCoreOrganizationUnitRepository : EfCoreRepository<ISufiIdentityDbContext, OrganizationUnit, Guid>, IOrganizationUnitRepository
{
    public EfCoreOrganizationUnitRepository(IDbContextProvider<ISufiIdentityDbContext> dbContextProvider)
