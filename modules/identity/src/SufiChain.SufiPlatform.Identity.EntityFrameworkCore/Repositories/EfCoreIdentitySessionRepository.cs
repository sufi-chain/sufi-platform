...
public class EfCoreIdentitySessionRepository : EfCoreRepository<ISufiIdentityDbContext, IdentitySession, Guid>, IIdentitySessionRepository
{
    public EfCoreIdentitySessionRepository(IDbContextProvider<ISufiIdentityDbContext> dbContextProvider)
