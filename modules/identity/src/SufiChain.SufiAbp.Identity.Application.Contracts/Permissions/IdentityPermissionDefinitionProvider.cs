...
namespace SufiChain.SufiAbp.Identity.Permissions;

/// <summary>
/// Defines permissions for the SufiAbp Identity module.
/// </summary>
public class IdentityPermissionDefinitionProvider : PermissionDefinitionProvider
{
    ...
    {
        return LocalizableString.Create<SufiAbpIdentityResource>(name);
    }
}
