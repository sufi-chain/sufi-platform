...
public static class SufiAbpIdentityDbContextModelCreatingExtensions
{
    public static void ConfigureSufiAbpIdentity([NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "Users", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "UserClaims", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "UserRoles", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "UserLogins", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "UserTokens", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "Roles", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "RoleClaims", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "ClaimTypes", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "OrganizationUnits", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "OrganizationUnitRoles", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "SecurityLogs", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "UserOrganizationUnits", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "LinkUsers", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "UserDelegations", SufiAbpIdentityDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpIdentityDbProperties.DbTablePrefix + "Sessions", SufiAbpIdentityDbProperties.DbSchema);
