...
public class EfCoreIdentityClaimTypeRepository : EfCoreRepository<ISufiAbpIdentityDbContext, IdentityClaimType, Guid>, IIdentityClaimTypeRepository
{
    public EfCoreIdentityClaimTypeRepository(IDbContextProvider<ISufiAbpIdentityDbContext> dbContextProvider)
