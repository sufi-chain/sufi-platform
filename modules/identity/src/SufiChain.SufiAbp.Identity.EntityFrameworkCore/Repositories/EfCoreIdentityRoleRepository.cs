...
public class EfCoreIdentityRoleRepository : EfCoreRepository<ISufiAbpIdentityDbContext, IdentityRole, Guid>, IIdentityRoleRepository
{
    public EfCoreIdentityRoleRepository(IDbContextProvider<ISufiAbpIdentityDbContext> dbContextProvider)
