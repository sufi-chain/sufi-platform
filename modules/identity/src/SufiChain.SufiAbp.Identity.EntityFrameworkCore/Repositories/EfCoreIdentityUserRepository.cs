...
public class EfCoreIdentityUserRepository : EfCoreRepository<ISufiAbpIdentityDbContext, IdentityUser, Guid>, IIdentityUserRepository
{
    public EfCoreIdentityUserRepository(IDbContextProvider<ISufiAbpIdentityDbContext> dbContextProvider)
