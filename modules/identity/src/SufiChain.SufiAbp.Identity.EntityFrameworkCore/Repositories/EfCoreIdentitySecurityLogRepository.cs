...
public class EfCoreIdentitySecurityLogRepository : EfCoreRepository<ISufiAbpIdentityDbContext, IdentitySecurityLog, Guid>, IIdentitySecurityLogRepository
{
    public EfCoreIdentitySecurityLogRepository(IDbContextProvider<ISufiAbpIdentityDbContext> dbContextProvider)
