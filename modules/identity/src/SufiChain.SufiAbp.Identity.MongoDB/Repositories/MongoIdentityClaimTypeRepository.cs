...
public class MongoIdentityClaimTypeRepository : MongoDbRepository<ISufiAbpIdentityMongoDbContext, IdentityClaimType, Guid>, IIdentityClaimTypeRepository
{
    public MongoIdentityClaimTypeRepository(IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
