...
public class MongoIdentitySecurityLogRepository :
    MongoDbRepository<ISufiAbpIdentityMongoDbContext, IdentitySecurityLog, Guid>, IIdentitySecurityLogRepository
{
    public MongoIdentitySecurityLogRepository(IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider)
