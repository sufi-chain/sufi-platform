...
public class MongoIdentityLinkUserRepository : MongoDbRepository<ISufiAbpIdentityMongoDbContext, IdentityLinkUser, Guid>, IIdentityLinkUserRepository
{
    public MongoIdentityLinkUserRepository(IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
