...
public class MongoIdentityRoleRepository : MongoDbRepository<ISufiAbpIdentityMongoDbContext, IdentityRole, Guid>, IIdentityRoleRepository
{
    public MongoIdentityRoleRepository(IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider)
