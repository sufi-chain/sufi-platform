...
public class MongoIdentitySessionRepository : MongoDbRepository<ISufiAbpIdentityMongoDbContext, IdentitySession, Guid>, IIdentitySessionRepository
{
    public MongoIdentitySessionRepository(IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider)
        : base(dbContextProvider)
    {

    }

    public virtual async Task<IdentitySession?> FindBySessionIdAsync(string sessionId, CancellationToken cancellationToken = default)
    {
