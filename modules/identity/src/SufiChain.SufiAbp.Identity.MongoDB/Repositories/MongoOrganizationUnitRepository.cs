...
public class MongoOrganizationUnitRepository
    : MongoDbRepository<ISufiAbpIdentityMongoDbContext, OrganizationUnit, Guid>,
    IOrganizationUnitRepository
{
    public MongoOrganizationUnitRepository(
        IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider)
        ...
        CancellationToken cancellationToken = default)
    {
        return await GetRolesAsync(
            await GetAsync(id, cancellationToken: cancellationToken),
            sorting,
            maxResultCount,
            skipCount,
            includeDetails,
    ...
    public virtual async Task<int> GetRolesCountAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await GetRolesCountAsync(await GetAsync(id, cancellationToken: cancellationToken), cancellationToken);
    }
    ...
    public virtual async Task<int> GetMembersCountAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await GetMembersCountAsync(
            await GetAsync(id, cancellationToken: cancellationToken),
            filter,
            includeChildren: false,
            cancellationToken);
