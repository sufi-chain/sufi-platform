...
public class MongoIdentityUserDelegationRepository : MongoDbRepository<ISufiAbpIdentityMongoDbContext, IdentityUserDelegation, Guid>, IIdentityUserDelegationRepository
{
    protected IClock Clock { get; }
    
    public MongoIdentityUserDelegationRepository(IMongoDbContextProvider<ISufiAbpIdentityMongoDbContext> dbContextProvider, IClock clock)
