...
public class MongoIdentityClaimTypeRepository : MongoDbRepository<ISufiIdentityMongoDbContext, IdentityClaimType, Guid>, IIdentityClaimTypeRepository
{
    public MongoIdentityClaimTypeRepository(IMongoDbContextProvider<ISufiIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
