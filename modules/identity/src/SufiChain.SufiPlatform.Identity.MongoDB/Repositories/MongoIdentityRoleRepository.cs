...
public class MongoIdentityRoleRepository : MongoDbRepository<ISufiIdentityMongoDbContext, IdentityRole, Guid>, IIdentityRoleRepository
{
    public MongoIdentityRoleRepository(IMongoDbContextProvider<ISufiIdentityMongoDbContext> dbContextProvider)
