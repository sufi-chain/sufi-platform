...
public class MongoIdentityUserDelegationRepository : MongoDbRepository<ISufiIdentityMongoDbContext, IdentityUserDelegation, Guid>, IIdentityUserDelegationRepository
{
    protected IClock Clock { get; }
    
    public MongoIdentityUserDelegationRepository(IMongoDbContextProvider<ISufiIdentityMongoDbContext> dbContextProvider, IClock clock)
