...
namespace SufiChain.SufiPlatform.Identity.MongoDB.Repositories;

public class MongoIdentityUserRepository : MongoDbRepository<ISufiIdentityMongoDbContext, IdentityUser, Guid>, IIdentityUserRepository
{
    public MongoIdentityUserRepository(IMongoDbContextProvider<ISufiIdentityMongoDbContext> dbContextProvider)
