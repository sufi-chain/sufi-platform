...
public class MongoIdentitySessionRepository : MongoDbRepository<ISufiIdentityMongoDbContext, IdentitySession, Guid>, IIdentitySessionRepository
{
    public MongoIdentitySessionRepository(IMongoDbContextProvider<ISufiIdentityMongoDbContext> dbContextProvider)
