...
public class FeatureDynamicInitializer : ITransientDependency
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var staticFeatureSaver = ServiceProvider.GetService<IStaticFeatureSaver>();
        if (staticFeatureSaver == null)
        {
            return;
        }
        ...
        FeatureManagementOptions options)
    {
        ...
        var dynamicFeatureDefinitionStore = ServiceProvider.GetService<IDynamicFeatureDefinitionStore>();
        if (dynamicFeatureDefinitionStore == null)
        {
            return;
        }
