...
namespace SufiChain.SufiAbp.SettingManagement.Blazor.Pages;

public partial class SettingsManagement : SettingManagementComponentBase
{
    ...
    [Inject] protected IOptions<SettingManagementComponentOptions> Options { get; set; } = default!;
