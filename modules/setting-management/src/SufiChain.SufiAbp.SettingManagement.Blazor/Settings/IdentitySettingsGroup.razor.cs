...
public partial class IdentitySettingsGroup : SettingManagementComponentBase, ISaveableSettingGroup
{
    ...
    private IStringLocalizer<SufiAbpIdentityResource> IdentityL =>
        LazyGetRequiredService(ref _identityLocalizer);

    private IStringLocalizer<SufiAbpAccountResource> AccountL =>
        LazyGetRequiredService(ref _accountLocalizer);

    private IIdentitySettingsAppService? _identitySettingsAppService;
    private IStringLocalizer<SufiAbpIdentityResource>? _identityLocalizer;
    private IStringLocalizer<SufiAbpAccountResource>? _accountLocalizer;
