...
namespace SufiChain.SufiAbp.SettingManagement.Blazor.Components;

/// <summary>
/// Modal component for managing settings with vertical tab navigation.
/// Matches the pattern used by PermissionManagementModal and FeatureManagementModal.
/// Settings are managed for the current context using Application Services (DDD-compliant).
/// </summary>
public partial class SettingManagementModal : SettingManagementComponentBase
{
    ...
    [Inject] private IOptions<SettingManagementComponentOptions> Options { get; set; } = default!;
