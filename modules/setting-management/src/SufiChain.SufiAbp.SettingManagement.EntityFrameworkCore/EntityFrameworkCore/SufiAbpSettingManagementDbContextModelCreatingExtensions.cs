...
public static class SufiAbpSettingManagementDbContextModelCreatingExtensions
{
    //TODO: Instead of getting parameters, get a action of SettingManagementModelBuilderConfigurationOptions like other modules
    public static void ConfigureSufiAbpSettingManagement(
        [NotNull] this ModelBuilder builder)
    {
        ...
        {
            b.ToTable(SufiAbpSettingManagementDbProperties.DbTablePrefix + "Settings", SufiAbpSettingManagementDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiAbpSettingManagementDbProperties.DbTablePrefix + "SettingDefinitions", SufiAbpSettingManagementDbProperties.DbSchema);
