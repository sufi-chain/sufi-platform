...
public class MongoTagLinkRepository : MongoDbRepository<ITagsManagementMongoDbContext, TagLink, Guid>, ITagLinkRepository
{
    public MongoTagLinkRepository(IMongoDbContextProvider<ITagsManagementMongoDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
