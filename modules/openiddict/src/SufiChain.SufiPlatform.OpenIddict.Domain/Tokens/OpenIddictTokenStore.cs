...
namespace SufiChain.SufiPlatform.OpenIddict.Tokens;

public class OpenIddictTokenStore : OpenIddictStoreBase<IOpenIddictTokenRepository>, IOpenIddictTokenStore<OpenIddictTokenModel>
{
