...
public static class OpenIddictApplicationExtensions
{
    ...
    /// <summary>
    /// Parsing the stringified JSON Web Key Set is an expensive operation; the resulting object is stored in a static cache.
    /// </summary>
    ...
    public static OpenIddictApplicationModel ToModel(this OpenIddictApplication entity)
    {
        ...
        var model = new OpenIddictApplicationModel
        {
            ...
            JsonWebKeySet = entity.JsonWebKeySet != null ? JsonWebKeySetCache.GetOrAdd(entity.JsonWebKeySet, static key => JsonWebKeySet.Create(key)) : null,
