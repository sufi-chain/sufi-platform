...
namespace SufiChain.SufiAbp.ShortLinkGenerator.EntityFrameworkCore.Repos;

public class EfCoreShortUrlRepository : EfCoreRepository<ISufiAbpShortLinkGeneratorDbContext, ShortUrl, Guid>, IShortUrlRepository
{
    private readonly IClock _clock;

    public EfCoreShortUrlRepository(
        IDbContextProvider<ISufiAbpShortLinkGeneratorDbContext> dbContextProvider,
        IClock clock)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var tableName = $"{SufiAbpShortLinkGeneratorDbProperties.DbTablePrefix}ShortUrls";
