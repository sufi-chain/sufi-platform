...
{
    public static void ConfigureSufiCalendar(this ModelBuilder builder)
    {
        Check.NotNull(builder, nameof(builder));

        builder.Entity<Calendars.Calendar>(b =>
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "Calendars", SufiCalendarDbProperties.DbSchema);
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "CalendarInheritances", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "WorkingHourRules", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        builder.Entity<CalendarException>(b =>
        {
            ...
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "Exceptions", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "Events", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "RecurrenceRules", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "EventOccurrenceExceptions", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "EventAttendees", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
        ...
        {
            b.ToTable(SufiCalendarDbProperties.DbTablePrefix + "EventReminders", SufiCalendarDbProperties.DbSchema);
            b.ConfigureByConvention();
