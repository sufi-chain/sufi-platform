...
public class MongoMenuItemRepository : MongoDbRepository<IMenuManagementMongoDbContext, MenuItem, Guid>, IMenuItemRepository
{
    public MongoMenuItemRepository(IMongoDbContextProvider<IMenuManagementMongoDbContext> dbContextProvider) : base(dbContextProvider) { }
