...
public class EfCoreMenuItemRepository : EfCoreRepository<IMenuManagementDbContext, MenuItem, Guid>, IMenuItemRepository
{
    public EfCoreMenuItemRepository(IDbContextProvider<IMenuManagementDbContext> dbContextProvider) : base(dbContextProvider) { }
