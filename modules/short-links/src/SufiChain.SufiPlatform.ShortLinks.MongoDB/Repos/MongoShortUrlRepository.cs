...
namespace SufiChain.SufiPlatform.ShortLinks.MongoDB.Repos;

public class MongoShortUrlRepository : MongoDbRepository<IShortLinksMongoDbContext, ShortUrl, Guid>, IShortUrlRepository
{
    private readonly IClock _clock;

    public MongoShortUrlRepository(
        IMongoDbContextProvider<IShortLinksMongoDbContext> dbContextProvider,
        IClock clock)
