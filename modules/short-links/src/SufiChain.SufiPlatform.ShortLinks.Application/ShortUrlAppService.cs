...
[RequiresFeature(SufiShortLinksFeatures.Enable, SufiShortLinksFeatures.ShortLinks)]
[Authorize(ShortLinksPermissions.ShortLinks.Default)]
public class ShortUrlAppService : SufiApplicationService, IShortUrlAppService
{
    ...
    [Authorize(ShortLinksPermissions.ShortLinks.Create)]
    ...
    public virtual async Task<ShortUrlDto> GetByShortCodeAsync(string shortCode)
    {
        ...
        if (entity == null)
        {
            throw new BusinessException(ShortLinksErrorCodes.ShortUrlNotFound)
    ...
    [Authorize(ShortLinksPermissions.ShortLinks.Delete)]
    ...
    [RequiresFeature(SufiShortLinksFeatures.Analytics)]
    ...
    {
        var value = await _settingProvider.GetOrNullAsync(ShortLinksSettings.ShortUrl.CacheExpirationMinutes);
